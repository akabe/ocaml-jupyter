...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6113518286221118dc9f464c511fdb28) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          tags = [];
          categories = [];
          files_ab = ["lib/core/JupyterVersion.ml.ab"];
          sections =
            [
               Flag
                 ({
                     cs_name = "install-kernel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Add ocaml-jupyter kernel to Jupyter";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Install jupyter.archimedes sub-package";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "jupyter";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "jupyter-repl";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "jupyter";
                      lib_findlib_name = Some "repl";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "jupyter-kernel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "jupyter";
                           InternalLibrary "jupyter-repl";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("yojson", None);
                           FindlibPackage ("lwt-zmq", None);
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "jupyter";
                      lib_findlib_name = Some "kernel";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "ocaml-jupyter-kernel";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "jupyter-kernel"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "cppo"];
                      bs_interface_patterns =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "JupyterMain.ml"});
               Library
                 ({
                     cs_name = "jupyter-notebook";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lib/notebook";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "jupyter";
                           FindlibPackage ("threads", None);
                           FindlibPackage ("base64", None);
                   ...
                   {
                      lib_modules =
                        ["JupyterNotebook"; "JupyterNotebookCommManager"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["JupyterNotebookRouter"; "JupyterNotebookUnsafe"];
                      lib_findlib_parent = Some "jupyter";
                      lib_findlib_name = Some "notebook";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "jupyter-archimedes";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "archimedes", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                      ...
                      bs_path = "lib/archimedes";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "jupyter-notebook";
                           FindlibPackage ("archimedes.cairo", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "cppo"];
                      bs_interface_patterns =
                   ...
                   {
                      lib_modules = ["JupyterArchimedes"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "jupyter";
                      lib_findlib_name = Some "archimedes";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$docdir/core";
                      doc_title = "OCaml Jupyter Core Library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir/notebook";
                      doc_title = "OCaml Jupyter Notebook Library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "jupyter-kernel";
                           InternalLibrary "jupyter-notebook";
                   ...
                   {exec_custom = false; exec_main_is = "TestJupyter.ml"});
               Test
                 ({
                     cs_name = "test_lib";
                     cs_data = PropList.Data.create ();
          ...
          distclean_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("rm", ["src/kernel.json"])))]
            };
          plugins =
     ...
     oasis_digest =
       Some "X\000\167\023\150\151\251\161'\220\168\241T\208\129\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
