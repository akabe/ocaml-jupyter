...
(* OASIS_START *)
(* DO NOT EDIT (digest: 70fb0282dcab30219a6e626a7c371c85) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Jupyter"; "JupyterZmqChannel"; "JupyterChannelIntf"
                        ];
                      lib_pack = false;
     ...
     oasis_digest = Some "?7\127\235\251\229\127\204AIDO\144\207\235\133";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
