...
(* OASIS_START *)
(* DO NOT EDIT (digest: 59db7da24cafff9f54fd4e8304745519) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["JupyterNotebook"; "JupyterNotebookComm"];
                      lib_pack = false;
     ...
     oasis_digest = Some "\181\193\139T\1998)\249Id\207:z\181\140\210";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
