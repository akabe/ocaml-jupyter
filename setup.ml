...
(* OASIS_START *)
(* DO NOT EDIT (digest: 031ccd5bbef8442d6a9f6517b6d98df3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "A OCaml kernel for Jupyter notebooks";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\128m]\196\020$\243T\"\133\192\255\196V\242\240";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
