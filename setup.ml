...
(* OASIS_START *)
(* DO NOT EDIT (digest: cf928247aa64ca4926036bc9da8b7fe7) *)
(*
...
let setup_t =
  {
                      ...
                      Some
                        (("ln",
                           [
                              "-f";
                              "\\$(pwd)/git/pre-commit";
                              "\\$(pwd)/\\$(git rev-parse --git-dir)/hooks/pre-commit"
                           ])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_digest = Some "\202&\244a\130\tbb\0252\229\161\233\255\166\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
