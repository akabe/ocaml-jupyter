...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2e42d06f49d01270efb04adb7d50fc86) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          conf_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("./git/init.sh", [])))];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
     ...
     oasis_digest = Some "#%u\149\244V\176\133\132S\017o8\165+\137";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
