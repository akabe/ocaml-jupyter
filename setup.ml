...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6d3e952b2100b3b013bb68650d452fa3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          tags = [];
          categories = [];
          files_ab = ["lib/kernel/JupyterVersion.ml.ab"];
          sections =
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["JupyterHmac"; "JupyterLog"];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\219\166\233:R\248,\210\0067\139\195!\155\154\248";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
