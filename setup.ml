...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3262ac62886a46a50274dae004f7f98e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Jupyter"; "JupyterChannelIntf"];
                      lib_pack = false;
     ...
     oasis_digest = Some "N\175\2524)\176\240\147\232\154L\198Ks\003\197";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
